test('should execute a success callback with arguments', function (done) {
...
test('should execute a failure callback with arguments', function (done) {
...
test('should not call the failure stack on success', function (done) {
  var success = Spy(function (data) {
    expect(data).to.eql({ doctor: 'who' });
  });
...
test('should accept the node callback converter - success', function (done) {
...
test('should accept the node callback converter - failure', function (done) {
...
test('should not call the success stack on failure', function (done) {
  var success = Spy(function (data) {
    expect(true).to.not.be.ok;
  });
...
test('should execute items added to the chain after completion immediately', function () {
  var doctor = new oath()
    , n = 0;
...
test('should exectute items added to the chain after async fulfillment', function (done) {
  var doctor = new oath()
    , n = 0;
...
test('should work on failure', function (done) {
  var doctor = new oath();
...
test('should work on success', function (done) {
  var doctor = new oath();
